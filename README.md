# Binary-Search-Tree
Binary Search Tree implementation in JavaScript For the Odin Full Stack Course
...
simple test is written in the BST file, that tests most of the tree's functionality. 
